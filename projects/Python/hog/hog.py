...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    total, i, indicator = 0, 1, 0
    while i <= num_rolls:
        aux = dice()
        if aux == 1:
            indicator = 1
        total, i = total + aux, i + 1
    if indicator == 1:
        return 1
    else:
        return total
...
def is_swap(score0, score1):
    ...
    if score0 <= 1 or score1 <= 1:
        return False
    elif max(score1, score0) % min(score1, score0) == 0:
        return True
    else:
        return False
    # END PROBLEM 4
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        if who == 0:
            ...
            updated_score = score0
            old_high = previous_high
            if diff > old_high and diff > 1:
                updated_high = diff
                print(diff, "points! That's the biggest gain yet for Player 0")
            elif diff > old_high and diff == 1:
                updated_high = diff
                print(diff, "point! That's the biggest gain yet for Player 0")
            else:
                updated_high = old_high
            return announce_highest(0, updated_high, updated_score)
        if who == 1:
            diff = score1 - previous_score
            updated_score = score1
            old_high = previous_high
            if diff > old_high and diff > 1:
                updated_high = diff
                print(diff, "points! That's the biggest gain yet for Player 1")
            elif diff > old_high and diff == 1:
                updated_high = diff
                print(diff, "point! That's the biggest gain yet for Player 1")
            else:
                updated_high = old_high
            return announce_highest(1, updated_high, updated_score)
    return say
    # END PROBLEM 7
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    if free_bacon(opponent_score) >= margin or is_swap(score, opponent_score):
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
